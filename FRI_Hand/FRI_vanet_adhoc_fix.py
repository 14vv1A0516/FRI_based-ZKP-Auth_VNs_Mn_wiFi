...
def topology():
    ...
    makeTerm (RSU2, cmd = "bash -c 'python3 RSU2_Hand.py;'")
    time.sleep(1)
    makeTerm (RSU1, cmd = "bash -c 'python3 RSU1_Auth.py ;'")
        ...
        for sta in net.stations:
            if str(sta) not in veh_rsui_auth_check and sta.wintfs[0].associatedTo is not None : 
                ...
                if RSUx == 'RSU1' and veh_rsui_auth_check[str(sta)] == 0:
                    ...
                    if str(sta) == 'sta1':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'F9NR1W7'  > auth_sta1.txt ;'") 
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta2':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'JYW9DSH'  > auth_sta2.txt;'") 
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1
                    
                    if str(sta) == 'sta3':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'CA6GGCR'  > auth_sta3.txt ;'") 
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta4':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'QSKRYNY'  > auth_sta4.txt ;'") 
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta5':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py '00R66IS'  > auth_sta5.txt ;'") 
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1
                    
                    if str(sta) == 'sta6':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py '7GEB0U7'  > auth_sta6.txt ;'") 
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta7':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py '086M2W1'  > auth_sta7.txt ;'") 
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta8':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'J5CEL4K'  > auth_sta8.txt ;'") 
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta9':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'RQDNJQU'  > auth_sta9.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta10':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'YDT4UOA'  > auth_sta10.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1
                    
                    if str(sta) == 'sta11':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py '18ZNFUU'  > auth_sta11.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta12':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'IL71A4H'  > auth_sta12.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1
                    
                    if str(sta) == 'sta13':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'HIGXVTC'  > auth_sta13.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta14':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'OUXVI8N'  > auth_sta14.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta15':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'FPIOUGO'  > auth_sta15.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1
                    
                    if str(sta) == 'sta16':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'UGTDMJF'  > auth_sta16.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta17':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'X6JCLDS'  > auth_sta17.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta18':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py '6U1XETG'  > auth_sta18.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1
                
                    if str(sta) == 'sta19':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'R6MHA43'  > auth_sta19.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta20':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py '4HD4Q53'  > auth_sta20.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1
                    # '''
                    if str(sta) == 'sta21':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py '094TLCN'  > auth_sta21.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta22':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'VQ5WH0O'  > auth_sta22.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta23':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'QRV2YE7'  > auth_sta23.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta24':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'DC1GCKE'  > auth_sta24.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta25':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py '54K99TX'  > auth_sta25.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1
                    
                    if str(sta) == 'sta26':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'PDIU4DB'  > auth_sta26.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta27':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'YT6NMSZ'  > auth_sta27.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta28':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'G1PIYJ3'  > auth_sta28.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta29':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'JHSM2ZO'  > auth_sta29.txt ;'") 
                        
                        print ("-------- Auth done for --- ", str(sta))
                        veh_rsui_auth_check[str(sta)] = 1

                    if str(sta) == 'sta30':
                        # x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Auth.py 'FWOGLI6'  > auth_sta30.txt ;'") 
                ...
                if RSUx == 'RSU2' and str(sta) not in veh_rsuj_hand_auth_check:    
                    ...
                    if str(sta) == 'sta1':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'F9NR1W7' 'T269YXL'> hand_sta1.txt ;'") 
                    ...
                    if str(sta) == 'sta2':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'JYW9DSH' 'DTCSL0K' > hand_sta2.txt ;'") 
                        print ("Handover done for ",str(sta))
                        veh_rsuj_hand_auth_check[str(sta)] = 1
                    ...
                    if str(sta) == 'sta3':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'CA6GGCR''SXEA9OI' > hand_sta3.txt ;'") 
                    ...
                    if str(sta) == 'sta4':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'QSKRYNY' 'N3KR7ES' > hand_sta4.txt ;'") 
                    ...
                    if str(sta) == 'sta5':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py '00R66IS' 'K3X8HLN' > hand_sta5.txt ;'") 
                    ...
                    if str(sta) == 'sta6':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py '7GEB0U7' 'Y1MXXC3' > hand_sta6.txt ;'") 
                    ...
                    if str(sta) == 'sta7':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py '086M2W1' 'RMHDMNI' > hand_sta7.txt ;'") 
                    ...
                    if str(sta) == 'sta8':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'J5CEL4K' '0L0SP34' > hand_sta8.txt ;'") 
                    ...
                    if str(sta) == 'sta9':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'RQDNJQU' '89QXAPR' > hand_sta9.txt ;'") 
                    ...
                    if str(sta) == 'sta10':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'YDT4UOA' 'PQB4DMI' > hand_sta10.txt ;'") 
                        print ("Handover done for ",str(sta))
                        veh_rsuj_hand_auth_check[str(sta)] = 1
                    ...
                    if str(sta) == 'sta11':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py '18ZNFUU' 'K1Q3NOA' > hand_sta11.txt ;'") 
                    ...
                    if str(sta) == 'sta12':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'IL71A4H' 'M1DPRTN' > hand_sta12.txt ;'") 
                    ...
                    if str(sta) == 'sta13':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'HIGXVTC' 'R71PNMH' > hand_sta13.txt ;'") 
                    ...
                    if str(sta) == 'sta14':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'OUXVI8N' 'HIG7KVW' > hand_sta14.txt ;'") 
                    ...
                    if str(sta) == 'sta15':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'FPIOUGO' '1VHTIKE' > hand_sta15.txt ;'") 
                    ...
                    if str(sta) == 'sta16':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'UGTDMJF' 'J5SD24B' > hand_sta16.txt ;'") 
                    ...
                    if str(sta) == 'sta17':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'X6JCLDS' 'K0N76FW' > hand_sta17.txt ;'") 
                    ...
                    if str(sta) == 'sta18':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py '6U1XETG' '6Z3VJW7' > hand_sta18.txt ;'") 
                    ...
                    if str(sta) == 'sta19':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'R6MHA43' '4KFQ6KI' > hand_sta19.txt ;'") 
                    ...
                    if str(sta) == 'sta20':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py '4HD4Q53' '1GEC5P3' > hand_sta20.txt ;'") 
                    ...
                    if str(sta) == 'sta21':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py '094TLCN' '9LF57PT' > hand_sta21.txt ;'") 
                    ...
                    if str(sta) == 'sta22':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'VQ5WH0O' 'H672EW9' > hand_sta22.txt ;'") 
                    ...
                    if str(sta) == 'sta23':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'QRV2YE7' 'A8OEFDY' > hand_sta23.txt ;'") 
                    ...
                    if str(sta) == 'sta24':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'DC1GCKE' 'L2EXGJ1' > hand_sta24.txt ;'") 
                    ...
                    if str(sta) == 'sta25':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py '54K99TX' '4XRW9GV' > hand_sta25.txt ;'") 
                    ...
                    if str(sta) == 'sta26':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'PDIU4DB' 'BQKEC08' > hand_sta26.txt ;'") 
                    ...
                    if str(sta) == 'sta27':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'YT6NMSZ' 'CSNZO5D' > hand_sta27.txt ;'") 
                    ...
                    if str(sta) == 'sta28':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'G1PIYJ3' '7Q8K7LR' > hand_sta28.txt ;'") 
                    ...
                    if str(sta) == 'sta29':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'JHSM2ZO' '7Z6I37X' > hand_sta29.txt ;'") 
                    ...
                    if str(sta) == 'sta30':
                        ...
                        x = makeTerm (sta, cmd = "bash -c 'python3 Veh_Hand.py 'FWOGLI6' 'SHQM85F' > hand_sta30.txt ;'") 
