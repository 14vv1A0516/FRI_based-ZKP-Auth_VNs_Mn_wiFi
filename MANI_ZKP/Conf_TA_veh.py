...
def handle_client(client_socket):
    ...
    if msg1[2] == "01R":
        ...
        if msg3[0] == NVID:
            ...
            print ("RSU Verifier key [ g_alpha, g_t_s_val ] = [ ", alpha, tx_val_on_s, " ]")
            ...
            sheet.row += [ msg1[1], NVIDnew, proving_key, alpha, tx_val_on_s, poly_deg, TA_reg_comp_time, TA_reg_latency ]
            sheet.save_as ("Conf_ZKP_Reg_TA_details.xlsx")

            print ("TA Reg Comp Time : ", TA_reg_comp_time)
            print ("TA Reg Latency : ", TA_reg_latency)
            print ("\nReg successful and stored in Excel \n************************")
        else :
