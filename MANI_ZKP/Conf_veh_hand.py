...
hand_sheet = pe.get_sheet(file_name="Conf_veh_hand_time.xlsx")

VID =  sys.argv[1] #sys.argv[1] #"7HW4L3N"
session_key = sys.argv[2] # sys.argv[2]
...
if hand_res[1] == auth_suc_r : # sys.argv[3] :
    ...
    hand_sheet.row += [veh_hand_comp_time, hand_latency]
    hand_sheet.save_as ("Conf_veh_hand_time.xlsx")

    print ("Veh comp time for hand is ", veh_hand_comp_time)
    print ("Veh Hand Latency is ", hand_latency)
